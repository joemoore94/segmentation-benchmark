...
tissue regions (e.g. dense tumor nests) where nuclear segmentation is
intrinsically harder and CellPose's calls drift from the platform reference.
...
|---|---|---|---|
| CellPose vs. Baysor | 1,120 / 981 | -15.0 / -16.9 | 2.9e-14 |
