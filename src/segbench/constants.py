...
METHOD_COLORS: dict[str, str] = {
    ...
    "cellpose_exp10um":              "#7EC8E3",
    "cellpose_exp20um":              "#0077B6",
    "stardist_exp10um":              "#B39DDB",
    "stardist_exp20um":              "#7B1FA2",
    "mesmer_exp10um":                "#EF9A9A",
    "mesmer_exp20um":                "#B71C1C",
    "10x_ranger_exp10um":            "#A5D6A7",
    "10x_ranger_exp20um":            "#1B5E20",
    "watershed_10x":                 "#2D6A4F",
    "watershed_stardist":            "#6A1E55",
    "watershed_mesmer":              "#7B0000",
    "baysor_prior_c05":              "#C8A27A",
    "cellpose_cyto3":                "#FF6B6B",
    "cellpose_cyto3_eosin":          "#C92A2A",
    "cellpose_cyto3_density":        "#FF8787",
    "mesmer_wholecell_eosin":        "#E5A100",
    "mesmer_wholecell_density":      "#FFD43B",
    "bidcell":                      "#E377C2",
    "segger":           "#C49C94",
}
...
METHOD_FAMILIES: dict[str, str] = {
    ...
    "cellpose_exp10um":              "Geometric",
    "cellpose_exp20um":              "Geometric",
    "stardist_exp10um":              "Geometric",
    "stardist_exp20um":              "Geometric",
    "mesmer_exp10um":                "Geometric",
    "mesmer_exp20um":                "Geometric",
    "10x_ranger_exp10um":            "Geometric",
    "10x_ranger_exp20um":            "Geometric",
    "watershed_10x":                 "Watershed",
    "watershed_stardist":            "Watershed",
    "watershed_mesmer":              "Watershed",
    "baysor_prior_c05":              "Transcript-density",
    "cellpose_cyto3":                "Whole-cell NN",
    "cellpose_cyto3_eosin":          "Whole-cell NN",
    "cellpose_cyto3_density":        "Whole-cell NN",
    "mesmer_wholecell_eosin":        "Whole-cell NN",
    "mesmer_wholecell_density":      "Whole-cell NN",
    "bidcell":                      "Multimodal",
    "segger":           "Multimodal",
}
